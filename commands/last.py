import discord
from utils.files import get_last_message_id_from_file, get_save_path
...
async def perform_last(request_message: discord.Message) -> None:
    ...
    (last_message_url, last_message_id) = get_last_message_id_from_file(get_save_path(request_message.guild.name, request_message.channel.name)) or ("Not found", "URL not found")
